...
void UI::run_user() {
    ...
    while (true) {
        ...
        int menuChoice;
        std::cout << "\n===== Menu =====\n";
        std::cout << "1. Add to basket.txt\n";
        std::cout << "2. Skip to next coat\n";
        std::cout << "3. View basket.txt\n";
        std::cout << "4. View total price\n";
        std::cout << "5. Open basket.txt file\n";
        std::cout << "0. Exit\n";
        ...
        switch (menuChoice) {
            case 1:
                try {
                    ...
                    std::cout << "Added trench coat to basket.txt.\n";
                } catch (const std::exception& e) {
                    std::cerr << "Error adding to basket.txt: " << e.what() << std::endl;
                }
                break;
            ...
            case 3:
                std::cout << "Current basket.txt contents:\n";
